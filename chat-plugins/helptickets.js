	...
	help: {
		request(query, user, connection) {
			...
			const pages = {
				...
				inap: `Quelqu'un tient des propos innapropriés (injures, pseudo innaproprié, comportement, etc...)`,
				timerstalling: `Quelqu'un me timestall (Volontairement)`,
				staff: `J'aimerais report un membre du staff (Peu importe la raison)`,

				appeal: `J'aimerais faire opposition à ma sentence`,
				permalock: `J'aimerais faire opposition à mon permalock`,
				...
				confirminapname: `Report un pseudo (nom d'utilisateur) innaproprié`,
				confirminappokemon: `Report pseudo de Pokémon innaproprié`,
				confirmtimerstalling: `Report du timestall`,
				confirmreportroomowner: `Report un Room Owner (#)`,
				confirmreportglobal: `Report un membre du Global Staff`,
				confirmappeal: `Faire opposition à mon lock`,
			...
			const ticketTitles = {
				...
				inappokemon: `Pseudo de Pokémon innaproprié `,
				timerstalling: `Timestall`,
				reportroomowner: `Plainte envers le Room Owner`,
				reportglobal: `Plainte envers un membre du Global Staff`,
				appeal: `Opposition`,
				ipappeal: `Opposition à l'IP lock`,
				appealsemi: `Opposition du lock à l'ISP`,
				ticket: `Report le dernier ticket`,
				other: `Autre`,
			};
